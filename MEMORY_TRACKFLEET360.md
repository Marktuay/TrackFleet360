...
* **Puerto del Servicio API**: `8085` (Local: `http://localhost:8085/api/v1`, Red Wi-Fi: `http://192.168.6.123:8085/api/v1`, GCP Producción IP `35.185.89.55`: `https://trackfleet360.newcenturyni.com/api/v1`)
...
* **Puerto del Servidor Web**: `3005` (Local: `http://localhost:3005`, Red Wi-Fi: `http://192.168.6.123:3005`, GCP Producción IP `35.231.193.40`: `https://app.newcenturyni.com`)
